...
async function sendEmailNotification(enquiry) {
  ...
  console.log('[Email] Attempting via Resend to', process.env.NOTIFY_EMAIL);
  ...
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'Aakassh.Creates <onboarding@resend.dev>',
  ...
  console.log(`[Email] Notification sent for enquiry from ${enquiry.name}`, data.id);
}
